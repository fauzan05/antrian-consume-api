                    ...
                    <div class="form-section">
                        ...
                        <form wire:submit="login">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="username" wire:model.live="username" class="form-control" id="username" placeholder="Masukkan username">
                                @error('username') <span class="error text-danger">{{ $message }}</span> @enderror
                            </div>
                            <div class="mb-4">
                                <label for="password" class="form-label">Password</label>
                                <input type="password" name="password" wire:model.live="password" class="form-control" id="password" placeholder="Masukkan password">
