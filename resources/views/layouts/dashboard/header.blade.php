        ...
        <div class="d-flex flex-column align-items-center text-bg-dark" style="width: 100%; height: 100vh">
          <div class="row">
            <div class="col-3 d-flex flex-row align-items-center m-4">
              <img src="{{ asset('storage/img/logo-puskesmas.png') }}" class="me-3 mb-2" alt="" style="width: 100%" />
              ...
              <div class="mt-auto">
                <div class="col-12 mb-4">
                  <div class="row d-flex align-items-center justify-content-center">
                    <div class="col-3">
                      <img src="{{ asset('storage/img/blank-profile.jpg') }}" class="rounded-circle" alt="" style="width: 100%;">
                    </div>
                    @livewire('get-current-user', ['token' => request()->cookie('token')])
                  </div>
                </div>
              </div>
            </div>   
